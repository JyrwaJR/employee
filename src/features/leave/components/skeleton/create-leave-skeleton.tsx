...
/**
 * Skeleton loading state for the create leave form screen.
 *
 * Matches the layout of {@link CreateLeaveScreen}:
 ...
 * ```
 */
export const CreateLeaveSkeleton = () => (
    ...
    <KeyboardSafeView className="flex-1">
      <ScrollView
        ...
        <View className="w-full gap-y-2">
          ...
          {/* Spacer before button — matches CreateLeaveScreen spacing */}
          <View className="h-4" />

          {/* Submit Button — h-11 matches Button default size */}
          <Skeleton className="h-11 w-full rounded" />

          {/* Bottom Spacer — matches CreateLeaveScreen spacing */}
          <View className="h-8" />
        </View>
      </ScrollView>
    </KeyboardSafeView>
